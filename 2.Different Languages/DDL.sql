...
INSERT INTO ORDER_DETAILS1 VALUES(1,curdate(),1251);
INSERT INTO ORDER_DETAILS1 VALUES(2,curdate(),1251);
INSERT INTO ORDER_DETAILS1 VALUES(3,curdate(),1255); -- LAWARISH ORDER POSSIBLE NAHI HE


-- ON DELETE CASCADE
DELETE FROM CUSTOMERS1 WHERE ID = 1251;